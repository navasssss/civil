...
<head>
      ...
      {{--
      <link rel="alternate" type="application/atom+xml" title="Atlas - home 2 - Atom"
            href="https://atlas-home2.blogspot.com/feeds/posts/default" />
      <link rel="alternate" type="application/rss+xml" title="Atlas - home 2 - RSS"
            href="https://atlas-home2.blogspot.com/feeds/posts/default?alt=rss" />
      <link rel="service.post" type="application/atom+xml" title="Atlas - home 2 - Atom"
            href="https://www.blogger.com/feeds/6110379639549342881/posts/default" /> --}}
      <!-- Google Font Poppins -->
                                                                                      ...
                                                                                      <article class='post postOuter item-{{ $loop->index }}'>
                                                                                                <div class='postImage'>
                                                                                                        <a href='{{ route('home.show', ['category' => $post->category->scheme, 'post' => $post->slug ?? $post->id]) }}'
                                                                                                                  title='{{ $post->title }}'>
                                                                                                                  <span class='hasImage'
                                                                                                                          data-style="{{  $post->thumbnail_url }}"></span>
                                                                                                        </a>
                                                                                                </div>
                                                                                                        ...
                                                                                                        <div class='postMeta'>
                                                                                                                  <div class='postAuthorAndTimestamp'>
                                                                                                                          <span class='authorImage'>
                                                                                                                                    <span class='hasImage'
                                                                                                                                            data-style='{{ $post->author->image_url }}'></span>
                                                                                                                          </span>
