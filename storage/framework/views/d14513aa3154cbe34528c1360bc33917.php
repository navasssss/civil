...
<head>
    ...
    <meta content='<?php echo e(asset('fashion-n.jpg')); ?>' property='twitter:image' />
                    ...
                    <div class='layout-3 section' id='layout-3' name='Main Layout'>
                        <div class='widget Blog' data-version='2' id='Blog1'>
                            <div class='widget-heading'>
                                <h3 class='queryInfo queryLabel querySuccess'><?php echo e($category->term); ?></h3>
                            </div>
                                        ...
                                        <article class='post postOuter item-<?php echo e($loop->index); ?>'>
                                            <div class='postImage'>
                                                <a href='<?php echo e(route('home.show', ['category' => $post->category->scheme ?? 'uncategorized', 'post' => $post->slug ?? $post->id])); ?>'
                                                    ...
                                                    <span class='hasImage'
                                                        data-style='<?php echo e(asset($post->thumbnail_url)); ?>'></span>
                                                </a>
                                            </div>
                                            <div class='postDetails'>
                                                <span class='postCat' data-cat='<?php echo e($post->category->term ?? 'uncategorized'); ?>'>
                                                    <a href='<?php echo e(route('home.category', ['category' => $post->category->term ?? 'uncategorized'])); ?>'><?php echo e(ucwords($post->category->term)); ?></a>
                                                </span>
                                                <h3 class='postTitle'>
                                                    <a href='<?php echo e(route('home.show', ['category' => $post->category->scheme ?? 'uncategorized', 'post' => $post->slug ?? $post->id])); ?>'
                                                        rel='bookmark'
...
</html><?php /**PATH C:\xampp\htdocs\civil\civil\resources\views\category.blade.php ENDPATH**/ ?>